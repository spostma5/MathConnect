...
public final class MyRoom extends com.google.api.client.json.GenericJson {
  ...
  /**
   * @param canvas canvas or {@code null} for none
   */
  public MyRoom setCanvas(java.lang.String canvas) {
    this.canvas = canvas;
    return this;
  }
  ...
  /**
   * @param paint paint or {@code null} for none
   */
  public MyRoom setPaint(java.lang.String paint) {
    this.paint = paint;
    return this;
  }
